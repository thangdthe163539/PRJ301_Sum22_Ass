...
public class EditPatientController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("Views/editpatientpage.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updatePatient(patientID, lastname, firstname, dob, address, email, phone, status, gender);
